...
import br.com.superrevendedores.android.raphael.desafio.common.api.ApiService;
...
public class PullRequestsUnitTest {
    ...
    public void shouldGetPullRequests() throws Exception {
        ...
        TestSubscriber<List<br.com.superrevendedores.android.raphael.desafio.common.api.response.PullRequest>> testSubscriber = new TestSubscriber<>();
        Flowable<List<br.com.superrevendedores.android.raphael.desafio.common.api.response.PullRequest>> flowable = apiService.getPullRequests(OWNER, REPO_NAME);
